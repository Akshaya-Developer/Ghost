...
namespace Ghostly.DAL.SQL
{
    ...
    public partial class GhostlyDBEntities : DbContext
    {
        public GhostlyDBEntities()
            : base("name=GhostlyDBEntities")
        {
        }
        ...
        public virtual ObjectResult<SPMain_Result> SPMain()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SPMain_Result>("SPMain");
        }
